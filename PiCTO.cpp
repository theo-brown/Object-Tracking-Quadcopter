...
int main()
{
   ...
   /***********************/
    ...
    while (rept == 1)
    {
        cout << "Done." << endl << "Taking preliminary image for colour recognition... (q to continue, r to restart, a to arm)";
        ...
        while (1)
        {
            ...
            if (c == 113) // q pressed
            {
                cout << "Proceeding to object tracking. (q to exit, a to arm)" << endl;
